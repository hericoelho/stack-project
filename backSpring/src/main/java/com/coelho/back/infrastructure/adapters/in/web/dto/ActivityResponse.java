...
public record ActivityResponse(String id, String title, String description, ActivityType type, ActivityStatus status,
		Instant createdAt) {
	public static ActivityResponse fromDomain(Activity activity) {
		return new ActivityResponse(activity.id(), activity.title(), activity.description(), activity.type(),
